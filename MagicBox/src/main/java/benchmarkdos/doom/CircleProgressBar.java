...
public class CircleProgressBar extends View {
    ...
    public void setProgress(float progress) {
        ...
        this.text = (int)((progress / max) * 100) + "%";
        invalidate();
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        textPaint.setColor(color);
        textPaint.setTextSize(Global.DensityToPixels(24));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (text!=null) {
            ...
            float x = (rectF.left + rectF.right) / 2 - (textBounds.width() / 2);
            float y = (rectF.top + rectF.bottom) / 2 + (textBounds.height() / 2);
