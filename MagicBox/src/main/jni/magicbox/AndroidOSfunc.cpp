...
extern "C" void Java_magiclib_core_NativeControl_nativeJoystick(JNIEnv * env, jobject obj, jint index, jint x, jint y, jint action, jint button)
{
...
extern "C" void Java_magiclib_core_NativeControl_nativeDpad(JNIEnv * env, jobject obj, jint index, jint x, jint y, jint action, jint button)
{
	if (!inputLockInitialized) {
		useInputLocks = 1;
		inputLockInitialized = true;
