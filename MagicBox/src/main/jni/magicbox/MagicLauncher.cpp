...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeStart(JNIEnv * env, jobject obj, jobject buffer, jint width, jint height, jint ver)
{
	androidWrapperVersion = ver;

	Android_Init(env, obj, buffer, width, height);
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeSetOption(JNIEnv * env, jobject obj, jint option, jint value, jobject value2)
{
	switch (option)
	{
		case 1:
		...
		case 18:
			...
			break;
		case 19:
			myLoader.twoPlayers = (value != 0);
			if (joytype != JOY_NONE) {
				JOYSTICK_Enable(1, (value != 0));
			}
			break;
	}
}
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeSaveState(JNIEnv * env, jobject obj, jstring path)
{
	std::string str;
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeLoadState(JNIEnv * env, jobject obj, jstring path)
{
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeMouseMax(JNIEnv * env, jobject obj, jboolean enabled, jint max_width, jint max_height)
{
	Mouse_SetMouseMax(enabled, max_width, max_height);
}

extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeSetAbsoluteMouseType(JNIEnv * env, jobject obj, jint type)
{
	Mouse_SetAbsoluteType(type);
}

extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeMouseRoundMaxByVideoMode(JNIEnv * env, jobject obj, jboolean enabled)
{
	Mouse_SetRoundMaxByVideMode(enabled);
}

extern "C" jint Java_benchmarkdos_doom_MagicLauncher_nativeGetMouseVideoWidth(JNIEnv * env, jobject obj)
{
	return Mouse_GetVideoWidth();
}

extern "C" jint Java_benchmarkdos_doom_MagicLauncher_nativeGetMouseVideoHeight(JNIEnv * env, jobject obj)
{
	return Mouse_GetVideoHeight();
}

extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeInit(JNIEnv * env, jobject obj)
{
	loadf = 0;
	myLoader.memsize = 2;
	myLoader.bmph = 0;
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativePause(JNIEnv * env, jobject obj, jint state)
{
	if ((state == 0) || (state == 1))
...
extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeStop(JNIEnv * env, jobject obj)
{
	myLoader.abort = 1;
}

extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeForceStop(JNIEnv * env, jobject obj)
{
	Android_ShutDown(true);
}

extern "C" void Java_benchmarkdos_doom_MagicLauncher_nativeShutDown(JNIEnv * env, jobject obj)
{
	myLoader.bmph = 0;
	myLoader.videoBuffer = 0;
}

extern "C" jint Java_benchmarkdos_doom_MagicLauncher_nativeGetLibArchitecture(JNIEnv * env, jobject obj)
{
	#if (DBXLIB_ARMEABI)
		return 0;	
	#else	
...
extern "C" jint Java_benchmarkdos_doom_MagicLauncher_nativeGetCoreType(JNIEnv * env, jobject obj)
{
	return GetCoreType();
}