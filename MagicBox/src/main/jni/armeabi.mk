...
#$(info aaaa $(USER_PROJECT_PATH))
#$(info ssss $(SHARED_SOURCES_PATH))
...
LOCAL_MODULE := dosbox
LOCAL_C_INCLUDES := $(SHARED_SOURCES_PATH)/MagicBox/MagicBox/src/main/jni/include
